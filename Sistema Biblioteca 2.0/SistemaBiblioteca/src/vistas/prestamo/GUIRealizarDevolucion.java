...
public class GUIRealizarDevolucion extends javax.swing.JInternalFrame {
    ...
    private void cargarCboEstudiantes(){
        try {
            ...
            for (int i = 0; i < listaEstudiantes.size(); i++) {
                cboEstudiantes.addItem(listaEstudiantes.get(i).getId()+ " - " + listaEstudiantes.get(i).getNombres()
                        + " " + listaEstudiantes.get(i).getApellidoPaterno() + " " + listaEstudiantes.get(i).getApellidoMaterno());
            }
    ...
    private void llenarJTableLibros(ArrayList<Prestamo> prestamos){
        
        DefaultTableModel dtm = new DefaultTableModel();
        
        String[] cabecera = {"ID préstamo", "Libro", "ID ejemplar", "Fecha del préstamo", "Finalización préstamo", "Condición"}; 
        ...
        for (int i = 0; i < prestamos.size(); i++) {
            ...
            dataLibros[1] = prestamos.get(i).getEjemplar().getLibro().getTitulo();
            dataLibros[2] = prestamos.get(i).getEjemplar().getIdejemplar();
            dataLibros[3] = prestamos.get(i).getFechaPrestamo();
            dataLibros[4] = prestamos.get(i).getFechaFinalizacionPrestamo();
            dataLibros[5] = prestamos.get(i).getDescripcion_estado_prestamo();
    ...
    private void btnGenerarDevolucionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGenerarDevolucionMouseClicked
        ...
        try {
            ...
            prestamoDAO.modificarEstadoPrestamo(idPrestamo);
    ...
    private void cboEstudiantesItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cboEstudiantesItemStateChanged
        ...
        try {
            ...
            llenarJTableLibros(prestamoDAO.obtenerPrestamosXIdEstudiante_XEstado(idEstudiante, 1));
