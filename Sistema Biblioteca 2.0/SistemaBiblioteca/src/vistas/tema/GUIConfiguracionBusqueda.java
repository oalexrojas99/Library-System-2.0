    ...
    public void cargarCboTemas(){
        try {
            ...
            for (int i = 0; i < listaTemas.size(); i++) {
                ...
                cboTemasInfo.addItem(listaTemas.get(i).getId()+ " - " + listaTemas.get(i).getDescripcion());
    ...
    public void cargarCboTemasARelacionar(){
        try {
            ...
            for (int i = 0; i < listaTemas.size(); i++) {
                ...
                if(!listaTemas.get(i).getDescripcion().equals(cboTemas.getSelectedItem().toString().split(" - ")[1])){
                    cboTemasARelacionar.addItem(listaTemas.get(i).getId()+ " - " + listaTemas.get(i).getDescripcion());
                }
